...
impl ReportCard {
    ...
    pub fn print_alpha_grade_card(&self) -> String {
        if self.grade > (5.5 * 97.0)/100.0 {
            format!("{} ({}) - achieved a grade of {}", &self.student_name, &self.student_age, "A+")
        }
        else { 
            format!("{} ({}) - achieved a grade of {}", &self.student_name, &self.student_age, "Some other grade")
        }
    }
}
...
mod tests {
    ...
    fn generate_alphabetic_report_card() {
        ...
        assert_eq!(report_card.print_alpha_grade_card(), "Gary Plotter (11) - achieved a grade of A+");
    }
}
